document.addEventListener('DOMContentLoaded', function(){
  ...
  function renderProperty(posts) {
    ...
    posts.forEach((post) => {
      output += `
        <div class="card h-100 lh-1">
          <img src="${post.image}" class="card-img-top m-1" alt="${post.listName}">
  ...
  fetch('https://real-estate-blog-yjn0.onrender.com/properties')
  .then(response => {
    if (!response.ok) {
  ...
  document.getElementById("addPostForm").addEventListener('submit', (e) => {
    ...
    fetch('https://real-estate-blog-yjn0.onrender.com/properties')
      ...
      .then(properties => {
        ...
        return fetch('https://real-estate-blog-yjn0.onrender.com/properties', {
          method: 'POST',
          headers: {
...
function editProperty(id) {
  fetch(`https://real-estate-blog-yjn0.onrender.com/properties/${id}`)
